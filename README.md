...
An end-to-end exploratory data analysis of the Superstore sales dataset using Python and Plotly.
...
| Chart | Type | Insight |
|-------|------|---------|
| Sales by Category | Bar (colored by margin) | Technology leads in both sales and margin |
| Profit by Region | Horizontal Bar | All regions profitable; West leads |
| Monthly Trend | Multi-line | Consistent Q4 spike every year |
| Sub-Category Performance | Bubble Chart | Tables losing money at high volume |
| Category Treemap | Treemap | Drill-down view of entire product hierarchy |
